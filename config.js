...
module.exports = {
    ...
    ALL: process.env.ALL_CAPTION === undefined ? 'ᴍᴀᴅᴇ ʙʏ BEN-MONSTER' : process.env.ALL_CAPTION,
    ...
    BOTNAME: process.env.BOT_NAME === undefined ? ' ༄ZONE  \n\n   *ωнαтsαρρ вσт™*   \n' : process.env.BOT_NAME,
    NOLOG: process.env.NO_LOG === undefined ? 'false' : process.env.NO_LOG,
    THERI_KICK: process.env.THERI_KICK === undefined ? 'false' : process.env.THERI_KICK,
    SONGD: process.env.SONGD === undefined ? '✮ZONE ÐØWNŁØÐłNG ¥ØUƦ $ØNG✮🎧' : process.env.SONGD,
    SONGU: process.env.SONGU === undefined ? '✮ZONE UPŁØλÐłNG ¥ØUƦ $ØNG🎧' : process.env.SONGU,
    ...
    BOTV2: process.env.BOTV2_NAME === undefined ? 'ZONE' : process.env.BOTV2_NAME,
    RUDHRA_AI: process.env.ZONE_AI === undefined ? 'false' : process.env.ZONE_AI,
    ...
    LOGO_NAME: process.env.LOGO_NAME === undefined ? 'ZONE' : process.env.LOGO_NAME,
    ...
    SUPPORT: "27658052694-1634134075",
    SUPPORT2: "27658052694-1617736751",
    SUPPORT3: "27658052694-1621015274"
};
